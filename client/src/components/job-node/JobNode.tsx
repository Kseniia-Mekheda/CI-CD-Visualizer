  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3">
        <div
          className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${selected ? 'bg-accent text-white' : 'bg-accent-light text-accent'}`}
        >
          <Box size={18} />
        </div>

        <div className="flex flex-col">
          <span className="font-bold text-light-text text-sm">
            {data.label}
          </span>
